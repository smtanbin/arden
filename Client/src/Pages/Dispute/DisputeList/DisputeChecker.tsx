...
const DisputeChecker: React.FC<string> = () => {
    ...
    const fatchData = async () => {
        ...
        try {
            const res: PayloadData = await api.useApi('GET', `/v1/dispute/get/${param}`)
    ...
    const fatchImageData = async () => {
        ...
        try {
            const res: ImgPayloadData = await api.useApi('GET', `/v1/dispute/get_image/${param}`)
